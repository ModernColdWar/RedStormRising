...
ctld.spawnableCrates = {
    ...
    ["Artillery"] = {
        ...
        { weight = 893, desc = "BM-27 MLRS", unit = "Uragan_BM-27", side = 1, cratesRequired = 1, internal = 0 },
        { weight = 894, desc = "MLRS Smerch", unit = "Smerch", side = 1, cratesRequired = 1, internal = 0 },
