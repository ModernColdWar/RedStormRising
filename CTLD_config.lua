...
ctld.minimumDeployDistanceFromEnemyBase = 20000 -- minimum distance to unpack/unload from an enemy base if it's the closest
...
ctld.crateWaitTime = 45 -- time in seconds to wait before you can spawn another crate
