    ...
    if _unit ~= nil and _unit:getPlayerName() ~= nil and _playerName == _unit:getPlayerName() then
        ...
        elseif csar.csarMode == 3 then
            ...
            if _lives == nil or _lives > 1 then
                ...
                local _text = string.format("CSAR ACTIVE! \n\nYou have " .. (_lives - 1) .. " lives remaining. Make sure you eject! This way you can be rescued by a friend or yourself to regain the life. FOX-3 Air2Air Missiles are LIMITED to 40 PER ROUND/TYPE check F10 MENU for more information")
