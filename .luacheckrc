...
stds.moose = {
    read_globals = {
        "BASE", "AIRBASE", "COMMANDCENTER", "DATABASE", "DESIGNATE", "DETECTION_AREAS", "EVENTHANDLER", "EVENTS",
        "GROUP", "MENU_GROUP", "MENU_GROUP_COMMAND", "MESSAGE", "SCHEDULER", "SET_CLIENT", "SET_GROUP", "SETTINGS",
        "SPAWN", "UNIT", "UTILS", "ZONE", "ZONE_AIRBASE", "_SETTINGS"
    }
}
