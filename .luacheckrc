...
stds.moose = {
    read_globals = {
        "AIRBASE", "COMMANDCENTER", "DATABASE", "DESIGNATE", "DETECTION_AREAS", "EVENTHANDLER", "EVENTS", "GROUP",
        "MENU_GROUP", "MENU_GROUP_COMMAND", "MESSAGE",
        "SET_CLIENT", "SET_GROUP", "SETTINGS", "SPAWN", "UTILS", "ZONE", "ZONE_AIRBASE",
        "_SETTINGS"
    }
}
